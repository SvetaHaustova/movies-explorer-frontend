...
function Navigation({ isHeaderMain }) {
                ...
                <nav className="navigation__container">
                    <ul className={`navigation__list ${isOpen && "navigation__list-sidebar"}`}>
                        ...
                        <li className="navigation__link-container">
                            <NavLink to="/movies" className={`navigation__link ${(isHeaderMain && !isOpen) && "navigation__link_type_main"}`} activeClassName="navigation__link_active">
                                Фильмы
                            </NavLink>
                        </li>
                        <li className="navigation__link-container">
                            <NavLink to="/saved-movies" className={`navigation__link ${(isHeaderMain && !isOpen) && "navigation__link_type_main"}`} activeClassName="navigation__link_active">
                                Сохранённые фильмы
                            </NavLink>
                        </li>
