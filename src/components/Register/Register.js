            ...
            <section className="register">
                ...
                <form className="register__form" name="register">
                    <label className="register__label">Имя 
                        <input className="register__input" type="text" name="name" minLength="2" maxLength="40" placeholder="имя" required />
                    ...
                    <button className={registerButtonClassName} type="submit">Зарегистрироваться</button>
                </form>
